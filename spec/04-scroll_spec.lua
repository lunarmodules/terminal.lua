describe("Scroll Module Tests", function()
  ...
  it("should return correct scroll region set sequence", function()
    assert.are.equal("\27[5;10r", scroll.set_regions(5, 10))
  end)
