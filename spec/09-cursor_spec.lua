...
describe("Cursor", function()
  ...
  describe("visible.apply_seq() (Stack)", function()
  ...
  describe("visible.push_seq() (Stack)", function()
  ...
  describe("visible.pop_seq() (Stack)", function()
  ...
  describe("shape.apply_seq() (Stack)", function()
  ...
  describe("shape.push_seq() (Stack)", function()
  ...
  describe("shape.pop_seq() (Stack)", function()
  ...
  describe("position.push_seq() (Stack)", function()
  ...
  describe("position.pop_seq() (Stack)", function()
