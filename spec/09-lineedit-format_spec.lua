describe("LineEdit:", function()
  ...
  describe("get_non_wrapped_line()", function()
    ...
    it("returns full string if less than size", function()
      local line = Lineedit("Hello, world!"):goto_home()
    ...
    it("returns empty string if cursor is at the end", function()
      local line = Lineedit("hello world!"):goto_end()
      local target_size = 15
      local result, cols = line:_get_non_wrapped_line(target_size)
      assert.are.equal("", tostring(result))
      assert.are.equal(0, cols)
  ...
  describe("get_wrapped_line()", function()
    ...
    local function testwrap(width)
      local fullline = Lineedit(text):goto_home()
      local formatted = {}
    ...
    it("wraps words", function()
      local line = Lineedit("hello 🚀 world! hello 🚀 world!")
  ...
  describe("pad_line()", function()
    ...
    it("pads a line whilst retaining cursor position", function()
      local line = Lineedit("hello world!"):goto_index(6)
  ...
  describe("format()", function()
    ...
    before_each(function()
      text = "Hello, this is a simple 🚀 test string to check the formatting functionality of " ..
             "the Lineedit class. It features word wrapping, padding, and cursor handling. " ..
             "The class supports both single-width and double-width characters, ensuring " ..
             "correct column calculations 🚀."
      line = Lineedit(text):goto_index(80)
    end)
    ...
    describe("no-wrap", function()
      ...
      it("formats a string", function()
        ...
        assert.are.same({
          ...
          'ng functionality of |the Lineedit class. It features word wra',
      ...
      it("formats a string with padding", function()
        ...
        assert.are.same({
          ...
          'matting functionality of |the Lineedit class. It features wor',
      ...
      it("single result-line padding", function()
        line = Lineedit("will go into a single line"):goto_index(10)
        assert.are.same({
      ...
      describe("cursor-position", function()
        ...
        it("moves cursor to start of next line if at the end", function()
          local pos = 10
          line = Lineedit("will go into a single line (not really)"):goto_index(pos)
          assert.are.same({
            'will go i|',
            '|nto a sin',
            'gle line |',
        ...
        it("adds new line if cursor is at the end of the last line", function()
          line = Lineedit("some test data"):goto_end():left(2)
          assert.are.same({
            {
              'some test da|ta'
            },
          ...
          line = Lineedit("some test data"):goto_end():left(1)
          assert.are.same({
            {
              'some test dat|a'
            },
          ...
          line = Lineedit("some test data"):goto_end()
          assert.are.same({
            'some test data|',
            '|',
          }, testwrap({
          ...
          line = Lineedit("sometestdata"):goto_end():left(2)
          assert.are.same({
            'some|',
            'test|',
            'da|ta',
          ...
          line = Lineedit("sometestdata"):goto_end():left(1)
          assert.are.same({
            'some|',
            'test|',
            'dat|a',
          ...
          line = Lineedit("sometestdata"):goto_end()
          assert.are.same({
            'some|',
            'test|',
            'data|',
    ...
    describe("word-wrap", function()
      ...
      it("formats a string", function()
        ...
        assert.are.same({
          ...
          'formatting functionality of |the Lineedit class. It features ',
      ...
      describe("cursor-position", function()
        ...
        it("puts cursor in proper position", function()
          line = Lineedit("will go into a single line"):goto_index(14)
          local expected = tostring(line:insert("|"))
          line:backspace() -- remove inserted cgar again
        ...
        it("doesn't add the extra newline if set to do so", function()
          line = Lineedit("some testdata"):goto_end()
          assert.are.same({
            'some |',
            'testdata|',
          }, testwrap({
